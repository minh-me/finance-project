...
import { AccountStatus, AccountTypeEnum, GenderEnum, RoleEnum } from "~/utils/enums";
...
export const listings: SafeListing[] = [
  {
    ...
    category: categoryData[Math.floor(Math.random() * categoryData.length)].label,
    locationValue: "AI",
    guestCount: 2,
    roomCount: 1,
    bathroomCount: 1,
  },
  {
    ...
    description: "A lovely house with a beautiful garden, perfect for a family vacation.",
    price: 200,
    imageUrl:
  ...
  },
  {
    ...
    description: "An elegant villa situated by the beach, offering stunning ocean views.",
    price: 500,
    imageUrl:
  ...
  },
  {
    ...
    description: "A charming loft nestled in the historic district, close to all attractions.",
    price: 80,
    imageUrl:
  ...
  },
  {
    ...
    description: "A modern condo with panoramic city views, perfect for urban living.",
    price: 150,
    imageUrl:
  ...
  },
  {
    ...
    description: "A cozy cottage hidden in the woods, ideal for a peaceful getaway.",
    price: 180,
    imageUrl:
  ...
  },
  {
    ...
    description: "A stylish apartment located near the shopping center, with modern amenities.",
    price: 120,
    imageUrl:
  ...
  },
  {
    ...
    description: "A rustic cabin overlooking the lake, perfect for nature lovers.",
    price: 250,
    imageUrl:
